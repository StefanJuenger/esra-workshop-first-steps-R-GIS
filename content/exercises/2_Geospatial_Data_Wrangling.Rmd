...
```{block, opts.label = "clues"}
You can either do it on-the-fly using `dplyr::mutate()` as on the slides (XXX), or create first a new object and then add it using `base-R` (`corona_cologne$immigrant_share <- ...`). You could even combine the approaches.
