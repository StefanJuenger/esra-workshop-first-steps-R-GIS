...
.pull-left[
```{r corona-mapview, fig.align='center', eval = FALSE, out.height="50%"}
mapview::mapview(
...
.pull-right[
```{r corona-mapview-exec, fig.align='center', echo = FALSE, eval = FALSE, out.height="50%"}
mapview::mapview(
  corona_cologne["anzhl_g"]
)
```
...
.pull-left[
```{r hospitals-mapview, fig.align='center', eval = FALSE, out.height="50%"}
mapview::mapview(
